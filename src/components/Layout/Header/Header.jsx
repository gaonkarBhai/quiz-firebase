  ...
  return (
    <div className="header" style={{ background: "#0f0f0f" }}>
      ...
      {Location.pathname === "/question" ? (
        <img src={SARK} alt="SARK" className="ques_header" />
      ) : (
        ""
      )}
      ...
      {Location.pathname === "/" ? (
        <>
          ...
          {logged ? (
            <button className="header_btn" onClick={handleSignIn}>
              {" "}
              Sign In{" "}
            </button>
          ) : (
            <>
              ...
              <button className="header_btn" onClick={logout}>
                {" "}
                Logout{" "}
              </button>
            </>
      ...
      {Location.pathname === "/user-questions" ? (
        <>
          <img src={SARK} alt="SARK" />{" "}
          <button className="header_btn" onClick={handleScreen}>
            {" "}
            Enter FullScreen{" "}
          </button>
        </>
      ...
      {Location.pathname === "/login" ? (
        <>
          {" "}
          <img src={SARK} alt="SARK" />{" "}
          <button className="header_btn" onClick={handleRegister}>
            {" "}
            Register{" "}
          </button>{" "}
        </>
